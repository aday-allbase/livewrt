...
// Variables
const rootDomain = "adayall.my.id"; // Ganti dengan domain utama kalian
const serviceName = "livewrt"; // Ganti dengan nama workers kalian
const apiKey = "12a88f240df27c22432dafdd61b3532f3a513"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "maxroepz48@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "df78bd982642dbe6500a40a5b2fd7cc5"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "9f74832723b7440d1e6a1db0860942e9"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
...
const PROXY_BANK_URL = "https://raw.githubusercontent.com/aday-allbase/Nautica/refs/heads/main/proxyList.txt";
